...
|---|---|---|
| retail | `http://localhost:8001` | `https://raif-offsite-c-retail.onrender.com` |
| cib | `http://localhost:8002` | `https://raif-offsite-c-cib.onrender.com` |
| backend | `http://localhost:8003` | `https://raif-offsite-c-backend.onrender.com` |
