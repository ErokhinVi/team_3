...
|---|---|---|---|
| retail | `http://localhost:8001` | `https://raif-offsite-c-retail.onrender.com` | `https://team3-retail.erokhinva.workers.dev` |
| cib | `http://localhost:8002` | `https://raif-offsite-c-cib.onrender.com` | `https://team3-cib.erokhinva.workers.dev` |
| backend | `http://localhost:8003` | `https://raif-offsite-c-backend.onrender.com` | `https://team3-backend.erokhinva.workers.dev` |
